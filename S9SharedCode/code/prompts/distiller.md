...
Notes:
  ...
  - When the question asks for a comparison or a top N list, emit a `comparison_table` key containing the formatted Markdown table, and an `items` array with the structured fields.
