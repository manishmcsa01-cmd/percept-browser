...
async def run_with_tools(*, prompt: str, tools_payload: list[dict],
    ...
    # Hit the hop cap. Return a synthetic error so the caller knows it failed.
    return {
        "text": '{"error": "MAX_TOOL_HOPS exceeded. The model entered an infinite loop or took too many steps."}',
        "tool_calls": []
    }
